        ...
        <div className="about-container">
            <div className="left-about">
                ...
                <div className="left-about-call-box">
                    <div className="left-about-call-box1">
                        <p>CALL NOW TO BOOK</p>
                        <p>604.356.3617</p>
                        <p>(8 am till 8pm)</p>
                    </div>
                    <div className="left-about-call-box2">
                        <p>Schedule</p>
                        <p>Appointment</p>
                    </div>
                </div>
                ...
                <div className="left-about-reviews">
                    <br/>*****<br/>
                    The doctor's exam involves a health questionnaire plus a
            ...
            <div className="right-about" >
                ...
                <div className="about-exam-notes">
                    <li>You don't need to bring photos.</li>
                    <li>No fasting is required.</li>
                </div>
            </div>
        </div>
    );
